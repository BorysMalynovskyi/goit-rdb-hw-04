...
Скрипт: [create_db.sql](scripts/create_db.sql)
...
Скрипт: [insert_data.sql](scripts/insert_data.sql)
...
Скрипт: [join_query.sql](scripts/join_query.sql)
...
Скрипт: [4_1_count.sql](scripts/4_1_count.sql)
...
Скрипт: [4_2_left_join.sql](scripts/4_2_left_join.sql)
...
Скрипт: [4_3_right_join.sql](scripts/4_3_right_join.sql)
...
Скрипт: [4_4_employee_filter.sql](scripts/4_4_employee_filter.sql)
...
Скрипт: [4_5_group_by.sql](scripts/4_5_group_by.sql)
...
Скрипт: [4_6_having.sql](scripts/4_6_having.sql)
...
Скрипт: [4_7_order_by.sql](scripts/4_7_order_by.sql)
...
Скрипт: [4_8_limit_offset.sql](scripts/4_8_limit_offset.sql)
